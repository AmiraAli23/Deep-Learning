...
By changing the window from 10 to 4 and 6, it is clear that the higher the window size, the more smoother the "predicted" line appears. The smoother the line the better, as it reduces some of the harsher peaks in the graph. 
